...
NAV = [
    ...
    ("Governance as a Single Platform", "part2/governance-as-platform.md", 1),
    ...
    ("The School", "part2/examples/school.md", 2),
    ("The Hospital", "part2/examples/hospital.md", 2),
    ("Wikipedia / Open Source", "part2/examples/wikipedia.md", 2),
