...
Derived artefacts that draw on `../knowledge/`. Each subdirectory is an
independent project with its own audience, scope, and release cadence.
...
Projects may **reference**, **excerpt**, or **summarise** material from
`knowledge/`, but must not become the canonical home for any hierarchical
decomposition, evidence listing, or bibliography. Those live in
`knowledge/`.
