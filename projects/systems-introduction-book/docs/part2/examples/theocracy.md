...
[**→ Interactive D3 Visualization**](../../interactive/theocracy.html){ .md-button }
...
Same pattern as China post-1978: open rung-3 economic and technical channels (foreign direct investment, tourism, social-policy modernisation) while preserving VP1. *Evidence:* significant rapid social reform on questions previously closed (women's driving, public entertainment) accompanied by sustained closure on political-religious dissent. The structural argument: economic rung-3 evidence is admissible to the apex; political-religious rung-3 evidence is not.
